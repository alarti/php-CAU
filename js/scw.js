...
//******************************************************************************
    ...
    function scwSetDefaultLanguage()
        {try
            ...
            {// Spanish traslation by Alberto Arce
             scwToday               = 'Hoy:';
             scwClear               = 'Borrar';
             ...
             scwInvalidDateMsg      = 'La fecha seleccionada no es válida.\n';
             scwOutOfRangeMsg       = 'La fecha selecionada está fuera de rango.';
             scwDoesNotExistMsg     = 'La fecha seleccionada no existe.';
             scwInvalidAlert        = ['La Fecha inválida (',') será ignorada.'];
             scwDateDisablingError  = ['Error ',' no es un objeto fecha.'];
             scwRangeDisablingError = ['Error ',' debe seleccionar 2 fechas.'];
            }
        };
